...
Options:
    ...
    --ano                Pull VEP annotations by Monkol. Default is false.
...
if __name__ == "__main__":
    ...
    writer.write('\t'.join(['CHROM','POSITION','ID','REF','ALT','GENE_NAME',
                'FUNCTIONAL_CLASS','SIFT','PolyPhen2','loftee','AF','AC','AN'])+ '\t')
    ...
    if args['doTDT']:
        ...
        writer.write('\t'.join(['AVG_allelicBalance', 'AVG_Depth',
                            'AVG_Depth_Het', 'Nproband_HomoAlt',
